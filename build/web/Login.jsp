            ...
            <div class="modal__body">
                <form action="logging?action=${action}" method="post" class="auth-form">
                        ...
                        <div class="auth-form__form">
                            ...
                            <div class="auth-form__aside">
                                <div class="auth-form__help">
                                    <a href="" class="auth-form__help-link auth-form__help-forgot-password">Quên mia Password</a>
                    ...
                    <div style="display: flex; justify-content: center">
                        <p style="color: ${aftersignup == 1?"green":"red"}; font-size: 13px;">${loginMessage}</p>
                    </div>
                    ...
                    <div class="auth-form__socials">
                        ...
                        <a href="" class="btn btn--size-s btn--with-icon auth-form__socials--google">
                            ...
                            <span class="auth-form__socials-title">
                                Login with Food Processing Technology Account
                            </span>
                        </a>
                    </div>
                </form>
